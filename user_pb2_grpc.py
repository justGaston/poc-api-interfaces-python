...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetListUsers = channel.unary_unary(
                '/user.UserService/GetListUsers',
...
class UserServiceServicer(object):
    ...
    def GetListUsers(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetListUsers': grpc.unary_unary_rpc_method_handler(
                    servicer.GetListUsers,
...
class UserService(object):
    ...
    def GetListUsers(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/user.UserService/GetListUsers',
